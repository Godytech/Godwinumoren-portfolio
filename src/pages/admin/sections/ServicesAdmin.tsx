...
export const ServicesAdmin: React.FC = () => {
  const { items: services, addItem, updateItem, deleteItem, reorderItems, resetToDefault } =
    useFirestoreCollection<ServiceItem>("services", initialPortfolioData.services);
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-border/60">
        <div>
          <h2 className="text-2xl font-bold text-foreground tracking-tight">Services Management</h2>
          <p className="text-sm text-muted-foreground">
            Manage offerings, engineering competencies, and architecture consulting items.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {services.map((service, idx) => (
          <div
            key={service.id}
            className="glass-panel p-5 rounded-2xl border border-foreground/10 flex flex-col justify-between gap-4 hover:border-primary/30 transition-all"
          >
            <div>
              <div className="flex items-start justify-between gap-2 mb-2">
                ...
                <span className="text-[10px] font-mono text-muted-foreground">#{service.order}</span>
              </div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-border/50">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-1.5 rounded-lg bg-primary/10 hover:bg-primary/20 text-primary transition-colors cursor-pointer text-xs font-semibold flex items-center gap-1"
                >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
          <div className="glass-panel p-6 rounded-3xl border border-red-500/30 max-w-sm w-full space-y-4 shadow-2xl bg-card">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Are you sure you want to remove this service from the public page?
            </p>
            ...
            <form onSubmit={handleSaveModal} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Cloud Systems Architecture"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Comprehensive description of the service deliverables..."
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="Cpu">Cpu (Performance)</option>

...
export function DotPattern({
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {glow && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[450px] bg-primary/20 dark:bg-primary/30 blur-[140px] rounded-full pointer-events-none" />
      )}
    </div>
  );
}
